        ...
        >
          {activeTab === 'processes' && (
            <>
              ...
              <SectionDescription>
                We follow a structured, collaborative approach to every project
                we undertake.
              </SectionDescription>
              ...
              <ItemGrid>
                <Card>
                  ...
                  <CardDescription>
                    ...
                    audience through comprehensive research and stakeholder
                    interviews.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    Our team develops a detailed strategy that outlines the
                    project scope, timeline, deliverables, and success metrics.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    We create compelling visual designs and interactive
                    prototypes to bring your ideas to life and gather feedback.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    Our developers build robust, scalable solutions using the
                ...
                <Card>
                  ...
                  <CardDescription>
                    Rigorous testing ensures your product is bug-free,
                    performant, and meets all quality standards.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    We manage the launch process and provide ongoing support to
          ...
          {activeTab === 'capabilities' && (
            <>
              ...
              <SectionDescription>
                STING Collective brings together creative and technical
          ...
          {activeTab === 'projects' && (
            <>
              ...
              <SectionDescription>
                We work on diverse projects ranging from startups to established
                enterprises.
              </SectionDescription>
              ...
              <ItemGrid>
                <Card>
                  ...
                  <CardDescription>
                    Complete brand identity, web presence, and marketing
                ...
                <Card>
                  ...
                  <CardDescription>
                    Modernizing legacy systems and processes with contemporary
                    digital solutions.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    From concept to launch, we build innovative products that
                    solve real problems.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    Integrated marketing campaigns across digital and
                    traditional channels to maximize impact.
                  </CardDescription>
                </Card>
                ...
                <Card>
                  ...
                  <CardDescription>
                    Creating immersive digital experiences that engage and
                ...
                <Card>
                  ...
                  <CardDescription>
                    Analyzing, testing, and refining digital properties to drive
                    growth and achieve KPIs.
                  </CardDescription>
                </Card>
              </ItemGrid>
            </>
          ...
          {activeTab === 'milestones' && (
            <>
              ...
              <SectionDescription>
                Our journey of growth, innovation, and impact across the
                industry.
              </SectionDescription>
              ...
              <Milestone>
                ...
                <MilestoneContent>
                  ...
                  <MilestoneDescription>
                    Bringing together creative minds from across the continent
                    to build world-class digital experiences.
                  </MilestoneDescription>
                </MilestoneContent>
              </Milestone>
              ...
              <Milestone>
                ...
                <MilestoneContent>
                  ...
                  <MilestoneDescription>
                    Established ourselves as leading creative agency delivering
              ...
              <Milestone>
                ...
                <MilestoneContent>
                  ...
                  <MilestoneDescription>
                    Opened studios in key markets and assembled teams across
              ...
              <Milestone>
                ...
                <MilestoneContent>
                  ...
                  <MilestoneDescription>
                    Awarded numerous accolades for creativity, innovation, and
              ...
              <Milestone>
                ...
                <MilestoneContent>
                  ...
                  <MilestoneDescription>
                    Our work continues to drive meaningful change and create
                    opportunities for talent across the continent.
                  </MilestoneDescription>
                </MilestoneContent>
              </Milestone>
            </>
          ...
          {activeTab === 'roadmap' && (
            <>
              ...
              <SectionDescription>
                Our strategic vision for the future of creative technology and
                digital innovation.
              </SectionDescription>
              ...
              <Section>
                ...
                <List>
                  <ListItem>
                    Strengthen core creative and development capabilities
                  </ListItem>
                  <ListItem>
                    Expand our AI-powered design tools and automation
                  </ListItem>
                  <ListItem>
                    Build strategic partnerships with global tech leaders
                  </ListItem>
                  <ListItem>
                    Mentor next generation of digital creators
                  </ListItem>
                </List>
              </Section>
              ...
              <Section>
                ...
                <List>
                  <ListItem>
                    Launch proprietary digital products and platforms
                  </ListItem>
                  <ListItem>
                    Expand to 5 new markets across Africa and beyond
                  </ListItem>
                  <ListItem>
                    Double our team size with top talent acquisition
                  </ListItem>
                  <ListItem>
                    Establish thought leadership through research & publishing
                  </ListItem>
                </List>
              </Section>
              ...
              <Section>
                ...
                <List>
                  <ListItem>
                    Become top 3 creative agencies in Africa and Diaspora
                  </ListItem>
                  <ListItem>
                    Lead industry standards for digital excellence
                  </ListItem>
                  <ListItem>
                    Create impact initiatives supporting African tech ecosystem
                  </ListItem>
                  <ListItem>
                    Develop innovative solutions for emerging markets
                  </ListItem>
                </List>
              </Section>
            </>
          ...
          {activeTab === 'plans' && (
            <>
              ...
              <SectionDescription>
                Concrete steps we&apos;re taking to turn our vision into
                reality.
              </SectionDescription>
          ...
          {activeTab === 'manifesto' && (
            <>
              ...
              <ManifestoBlock>
                <p>
                  We believe in the power of creative thinking to transform
                  industries, communities, and lives.
                </p>
                <p>
                  We are committed to excellence in everything we do—from the
                  pixels on screen to the processes behind the scenes.
                </p>
              </ManifestoBlock>
              ...
              <Section>
                ...
                <List>
                  <ListItem>
                    <strong>Authenticity</strong> - We create genuine,
                    meaningful work that resonates with audiences
                  </ListItem>
                  <ListItem>
                    <strong>Innovation</strong> - We constantly push boundaries
                    and explore new possibilities
                  </ListItem>
                  <ListItem>
                    <strong>Inclusivity</strong> - We celebrate diverse
                    perspectives and ensure everyone&apos;s voice is heard
                  </ListItem>
                  <ListItem>
                    <strong>Impact</strong> - We measure success by the positive
                    change we create
                  </ListItem>
                  <ListItem>
                    <strong>Excellence</strong> - We refuse to compromise on
              ...
              <ManifestoBlock>
                <p>
                  We are storytellers, problem-solvers, and visionaries working
                  at the intersection of art and science.
                </p>
                <p>
                  Our goal is simple: to create work that matters, partnerships
                  that last, and futures that inspire.
                </p>
                <p>
                  Together, we&apos;re building the creative ecosystem Africa
                  deserves and the world needs.
                </p>
              </ManifestoBlock>
            </>
          )}
